...
<section class="pt-20 lg:pt-[120px] pb-8 lg:pb-[70px]" id="features">
    <div class="container">
        <div class="flex flex-wrap -mx-4">
            <div class="w-full px-4">
                ...
                ">
                  ...
                  text-body-color
                ">
                        Fokus dari Toko Minyak Jaya adalah untuk mendistribusikan produk-produk mulai dari minyak goreng dengan harga yang terjangkau dan terpercaya sejak 1988.
                    </p>
                </div>
            </div>
        </div>
                ...
                ">
                  ...
                  "></span>
                    ...
                    <p class="text-body-color mb-8 lg:mb-11">
                        Menjadi leading distributor dalam bidang consumer goods
                    </p>
            ...
            <div class="w-full md:w-1/2 lg:w-1/4 px-4">
                ...
                ">
                  ...
                  "></span>
                    ...
                    <p class="text-body-color mb-8 lg:mb-11">
                        Mempunyai coverage yang luas sehingga mudah dijangkau
                    </p>
                    <a href="javascript:void(0)" class="font-medium text-base text-body-color hover:text-primary">
                        Learn More
                    </a>
            ...
            <div class="w-full md:w-1/2 lg:w-1/4 px-4">
                ...
                ">
                  ...
                  "></span>
                    ...
                    <p class="text-body-color mb-8 lg:mb-11">
                        Memberi pelayanan yang memuaskan kepada seluruh channel & pelanggan.
                    </p>
                    <a href="javascript:void(0)" class="font-medium text-base text-body-color hover:text-primary">
                        Learn More
                    </a>
            ...
            <div class="w-full md:w-1/2 lg:w-1/4 px-4">
                ...
                ">
                  ...
                  "></span>
                    ...
                    <p class="text-body-color mb-8 lg:mb-11">
                        Kualitas yang kami berikan adalah yang terbaik.
                    </p>
                    <a href="javascript:void(0)" class="font-medium text-base text-body-color hover:text-primary">
                        Learn More
                    </a>
