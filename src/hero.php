        ...
        <div class="flex flex-wrap items-center -mx-4">
            <div class="w-full px-4">
              ...
              " data-wow-delay=".2s">
                ...
                ">
                  ...
                  max-w-[600px]
                ">
                        Disini Kami Menyediakan Produk-Produk Minyak Yang Anda Butuhkan
                        Jadi tetap selalu ada di depan anda.
                    </p>
            ...
            <div class="w-full px-4">
                <div class="mx-auto max-w-[845px] relative z-10 wow fadeInUp" data-wow-delay=".25s">
                    <div class="mt-16">
                        <img src="assets/images/hero/hero-image2.jpg" alt="hero" class="max-w-full mx-auto rounded-t-xl rounded-tr-xl " />
                    </div>
