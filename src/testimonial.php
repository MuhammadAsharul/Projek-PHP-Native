        ...
        <div class="flex flex-wrap">
            <div class="w-full mx-4">
                ...
                ">
                  ...
                  text-body-color
                ">
                        Ini adalah testimonial dari klien kami yang telah menggunakan layanan kami.
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="flex flex-wrap">
              ...
              ">
                    ...
                    <div class="ud-testimonial-content mb-6">
                        <p class="text-base tracking-wide text-body-color">
                            “Produknya bagus banget, worth it sama harganya. Puas banget sama produkya, juga sama pelayanannya sangat ramah. Terimakasih."
                        </p>
                    </div>
                  ...
                  ">
                        ...
                        <div class="ud-testimonial-meta">
                            <h4 class="text-sm font-semibold">Shinta </h4>
                            <p class="text-[#969696] text-xs">Pelanggan Andong</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="w-full md:w-1/2 lg:w-1/3 px-4">
              ...
              ">
                    ...
                    <div class="ud-testimonial-content mb-6">
                        <p class="text-base tracking-wide text-body-color">
                            "Tokonya paling lengkap yang ada di Boyolali. Semua minyak tersusun rapi sesuai dengan merk dan beratnya jadi kami dapat melihat dengan mudah".
                        </p>
                    </div>
                    <div class="ud-testimonial-info flex items-center">
                        <div class="
                  ...
                  ">
                        ...
                        <div class="ud-testimonial-meta">
                            <h4 class="text-sm font-semibold">Joko Mulyono</h4>
                            <p class="text-[#969696] text-xs">Pelanggan Nogosari</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="w-full md:w-1/2 lg:w-1/3 px-4">
              ...
              ">
                    ...
                    <div class="ud-testimonial-content mb-6">
                        <p class="text-base tracking-wide text-body-color">
                            “Pokoknya Paling Josssss!! Tetap semangat membangun UMKM dan membuka lapangan pekerjaan buat masyarakat."
                        </p>
                    </div>
                    <div class="ud-testimonial-info flex items-center">
                        <div class="
                  ...
                  ">
                        ...
                        <div class="ud-testimonial-meta">
                            <h4 class="text-sm font-semibold">Sri Mulyani</h4>
                            <p class="text-[#969696] text-xs">Menteri Keuangan</p>
                        </div>
                    </div>
                </div>
            </div>
