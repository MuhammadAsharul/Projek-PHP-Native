      ...
      <div class="w-full px-4">
        <div class="text-center mx-auto mb-[60px] max-w-[620px]">
          ...
          <p class="
                  ...
                  text-body-color
                ">
            Perkenalkan kami sebagai pelayan yang akan membantu anda dalam mencari minyak goreng yang cocok untuk anda.
          </p>
        </div>
      </div>
    </div>
    ...
    <div class="flex flex-wrap justify-center -mx-4">
      ...
      <div class="w-full sm:w-1/2 lg:w-1/4 px-4">
        <div class="mb-10 wow fadeInUp" data-wow-delay=".15s">
          ...
          <div class="text-center">
            <h4 class="font-medium text-lg text-dark mb-2">Muhammad</h4>
            <p class="font-medium text-sm text-body-color mb-5">
              Pemasok
            </p>
            <div class="flex items-center justify-center">
