<?php
//tangkap request url: index.php?hal=gudang_form_edit&id=3
$id = $_REQUEST['id'];
//buat object gudang
$obj = new Gudang();
//panggil fungsi untuk mendapatkan data sebuah gudang di modelnya
$data = $obj->getGudang($id);
?>
        ...
        <div class="flex flex-wrap items-center -mx-4">
            <div class="w-full px-4">
                <div class="text-center">
                    <h1 class="font-semibold text-white text-4xl">Gudang Form</h1>
                </div>
            </div>
        </div>
    </div>
...
<div class="px-4 w-full ">
    <div class="
        ...
        <form action="gudangController.php" method="post">
            <div class="mb-6">
