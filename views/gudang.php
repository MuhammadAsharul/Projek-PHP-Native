        ...
        <div class="flex flex-wrap items-center -mx-4">
            <div class="w-full px-4">
                <div class="text-center">
                    <h1 class="font-semibold text-white text-4xl">Gudang Page</h1>
                </div>
            </div>
        </div>
    </div>
...
<section class="pt-20 lg:pt-[120px] pb-10 lg:pb-20">
    <div class="container">
        <div class="flex flex-wrap -mx-4">
            <!-- Data gudang -->
            <?php
            //ciptakan object dari class gudang
            $obj = new Gudang();
            //panggil fungsi menampilkan data gudang
            $rs = $obj->getAll();
            //looping data gudang
            foreach ($rs as $p) {
            ?>
                    ...
                    ">
                        ...
                        <div class="flex">
                            ...
                            if (isset($user)) {
                                if ($role != 'pelanggan') {
                            ?>
                                    <a href="index.php?hal=edit_gudang&id=<?= $p['id'] ?>" class="bg-primary
                            rounded
                            inline-block
                            text-center
                            py-1
        ...
        ?>
                <div class=" text-center mx-auto mb-[60px] max-w-[620px] mt-4">
                    <span class="font-semibold text-lg text-white bg-primary mb-2 block py-4 px-6 rounded">
                        <a href="index.php?hal=form_gudang" class="text-center mx-auto mt-4">Tambah</a>
                    </span>
                </div>
        <?php }
        }
