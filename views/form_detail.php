              ...
              ">
                ...
                <form action="detailController.php" method="post">
                    <div class="mb-6">
                        ...
                        <input type="text" name="jml_beli" placeholder="5" class="
                      w-full
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" name="hrg_beli" placeholder="10000" class="
                      w-full
                      border-0 border-b border-[#f1f1f1]
                      focus:border-primary focus:outline-none
                      py-4
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" name="produk_id" placeholder="1" class="
                      w-full
                      border-0 border-b border-[#f1f1f1]
                      focus:border-primary focus:outline-none
                      py-4
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" name="pembelian_id" placeholder="1" class="
                      w-full
                      border-0 border-b border-[#f1f1f1]
                      focus:border-primary focus:outline-none
                      py-4
