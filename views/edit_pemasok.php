<?php
//tangkap request url: index.php?hal=pemasok_form_edit&id=3
$id = $_REQUEST['id'];
//buat object pemasok
$obj = new Pemasok();
//panggil fungsi untuk mendapatkan data sebuah pemasok di modelnya
$data = $obj->getPemasok($id);
?>
        ...
        <div class="flex flex-wrap items-center -mx-4">
            <div class="w-full px-4">
                <div class="text-center">
                    <h1 class="font-semibold text-white text-4xl">Pemasok Form</h1>
                </div>
            </div>
        </div>
    </div>
...
<div class="px-4 w-full ">
    <div class="
        ...
        <h3 class="font-semibold mb-8 text-2xl md:text-[26px]">
            Edit Pemasok <?= $data['id'] ?>
        </h3>
        <form action="pemasokController.php" method="post">
            <div class="mb-6">
                <label for="nama" class="block text-xs text-dark">Name*</label>
            ...
            <div class="mb-6">
                <label for="alamat" class="block text-xs text-dark">Alamat*</label>
            ...
            <div class="mb-6">
                ...
                <input type="text" name="no_telp" class="
                      w-full
                      border-0 border-b border-[#f1f1f1]
                      focus:border-primary focus:outline-none
                      py-4
