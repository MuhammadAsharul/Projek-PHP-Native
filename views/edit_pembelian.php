<?php
//tangkap request url: index.php?hal=pembelian_form_edit&id=3
$id = $_REQUEST['id'];
//buat object pembelian
$obj = new Pembelian();
//panggil fungsi untuk mendapatkan data sebuah pembelian di modelnya
$data = $obj->getPembelian($id);
?>
    ...
    <div class="
        ...
        <form action="pembelianController.php" method="post">
            ...
            <div class="mb-6">
                ...
                <input type="text" name="pemasok_id" class="
                      w-full
                      border-0 border-b border-[#f1f1f1]
                      focus:border-primary focus:outline-none
                      py-4
