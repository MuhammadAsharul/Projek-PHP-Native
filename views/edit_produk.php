<?php
//tangkap request url: index.php?hal=produk_form_edit&id=3
$id = $_REQUEST['id'];
//buat object produk
$obj = new Produk();
//panggil fungsi untuk mendapatkan data sebuah produk di modelnya
        ...
        <div class="flex flex-wrap items-center -mx-4">
            <div class="w-full px-4">
                <div class="text-center">
                    <h1 class="font-semibold text-white text-4xl">Produk Form</h1>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="
        ...
        <form action="produkController.php" method="post">
            <div class="mb-6">
                ...
                <input type="text" name="nama_produk" class="
                      w-full
            ...
            <div class="mb-6">
                <label for="harga" class="block text-xs text-dark">Harga*</label>
                <input type="text" name="harga" class="
                      w-full
                      border-0 border-b border-[#f1f1f1]
                      focus:border-primary focus:outline-none
                      py-4
