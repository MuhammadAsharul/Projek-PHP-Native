        ...
        <div class="flex flex-wrap items-center -mx-4">
            <div class="w-full px-4">
                <div class="text-center">
                    <h1 class="font-semibold text-white text-4xl">Detail Pembelian Page</h1>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="w-full md:w-1/2 lg:w-1/3 px-4">
                  ...
                  ">
                            ...
                            <p class="text-base text-body-color mb-3">
                                <b>Jumlah Harga</b> : <?= $p['jml_beli'] ?>
                            </p>
                            <p class="text-base text-body-color mb-3">
                                <b>Harga Beli</b> : <?= $p['hrg_beli'] ?>
                            </p>
                            <p class="text-base text-body-color mb-3">
                                <b>ID Produk</b> : <?= $p['produk_id'] ?>
                            </p>
                            <p class="text-base text-body-color mb-3">
                                <b>ID Pembelian</b> : <?= $p['pembelian_id'] ?>
                            </p>
                        </div>
                        ...
                        <div class="flex">
                            ...
                            if (isset($user)) {
                                if ($role != 'pelanggan') {
                            ?>
                                    <a href="index.php?hal=edit_detail&id=<?= $p['id'] ?>" class="bg-primary
                                        rounded
                                        inline-block
                                        text-center
                                        py-1
        ...
        <div class="text-center mx-auto mb-[60px] max-w-[620px] mt-4">
            ...
            ?>
                    <span class="font-semibold text-lg text-white bg-primary mb-2 block py-4 px-6 rounded">
                        <a href="index.php?hal=form_detail" class="text-center mx-auto mt-4">Tambah</a>
                    </span>
            <?php }
            }
            ?>
